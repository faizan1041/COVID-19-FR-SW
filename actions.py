...
#            dispatcher.utter_message(template="utter_greet")
            dispatcher.utter_message(template="utter_ONLY_greet_with_name_fr")
        return[]

class FirstTimeFormSW(FormAction):

    def name(self) -> Text:
        return "first_time_form_sw"
...
#            dispatcher.utter_message(template="utter_greet")
            dispatcher.utter_message(template="utter_ONLY_greet_with_name_sw")
        return[]

class FeedbackFormFR(FormAction):

    def name(self) -> Text:
        return "feedback_form_fr"
...
class FeedbackFormSW(FormAction):
    ...
    def submit(
        ...
        dispatcher.utter_message(template="utter_ONLY_thanks_for_your_feedback_sw")
        return[]

class LanguageQuestionsFormFR(FormAction):

    def name(self) -> Text:
        return "language_questions_form_fr"
    ...
    def submit(
        ...
        dispatcher.utter_message(template="utter_ONLY_get_back_on_topic_fr")
        return[]

class LanguageQuestionsFormSW(FormAction):

    def name(self) -> Text:
        return "language_questions_form_sw"
    ...
    def submit(
        ...
        dispatcher.utter_message(template="utter_ONLY_get_back_on_topic_sw")
        return[]
